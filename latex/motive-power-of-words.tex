...
\documentclass[
  12pt,       % 10pt, 11pt, 12pt
  letter,    % a4paper, letterpaper, a5paper, b5paper, executivepaper, legalpaper
  final,      % draft
  onecolumn,  % twocolumn
  oneside,    % twoside
...
% Essay prompt specifically requested there to be NO bibliography or external
% sources/citations!
